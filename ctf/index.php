...
<body>
    ...
    <div class="sidebar">
        <a href="../"><i class="fa-solid fa-laptop"></i> <span class="side-link">Home</span></a>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <a href="../ctf/" class="active"><i class="fa-solid fa-flag"></i><span class="side-link"> CTFLab</span></a>
    ...
    <section id="banner">
        <div class="row d-flex justify-content-center">
            <?php
            $tampil = mysqli_query($conn, "SELECT * FROM ctf");
            while ($data = mysqli_fetch_array($tampil)) {
            ?>
                <div class="card" style="width: 25rem;">
                    <div class="card-body">
                        <img src="img/<?= $data["gambar"] ?>" alt="" class="card-img">
                        <br>
                        <h5 class="card-title"><?= $data["judul"] ?></h5>
                        <p class="card-text"><?= $data["deskripsi"] ?></p>
                        <p class="text-muted"><?= $data["waktu"] ?> by <?= $data["author"] ?></p>
                        <a href="<?= $data["path"] ?>" class="btn btn-primary">Play <i class="fa-solid fa-play"></i></a>
                    </div>
                </div>
            <?php } ?>
        </div>
